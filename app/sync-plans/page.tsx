            ...
            <div className="max-w-7xl w-[95%] rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                    ...
                    <div className="bg-white border border-[#e5e7eb] rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col shadow-lg">
                        ...
                        <div className="mb-4 md:mb-6">
                            <div className="flex items-baseline">
                                <span className="text-3xl md:text-4xl font-bold text-[#212626]">₹149.00</span>
                                <span className="ml-2 text-sm md:text-base text-[#667085]">per month</span>
                            </div>
                            <div className="text-[#667085] text-xs md:text-sm mt-1">
                                ₹1,788.00/year <span className="text-[#667085]">Billed annually</span>
                            </div>
                        </div>

                        <button className="w-full bg-[#1eb386] hover:bg-[#40c79a] text-white py-2.5 md:py-3 rounded-lg font-medium mb-3 md:mb-4">
                            Purchase
                        </button>

                        <p className="text-center text-[#667085] text-xs md:text-sm mb-6 md:mb-8">Comes with 14 days free trial</p>
                        ...
                        <div className="space-y-3 md:space-y-4 flex-grow">
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Single user access</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    ...
                                    <span className="text-[#212626] font-medium">50 Invoices</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    ...
                                    <span className="text-[#212626] font-medium">100 Products</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    ...
                                    <span className="text-[#212626] font-medium">Before & After Tax Reports</span>
                                </div>
                            </div>
                        ...
                        <div className="flex items-start gap-2 md:gap-3">
                            ...
                            <div className="text-sm md:text-base">
                                ...
                                <span className="text-[#212626] font-medium">Data across Unlimited Devices</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-[#e5e7eb] rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col relative shadow-lg">
                        ...
                        <div className="mb-4 md:mb-6">
                            <div className="flex items-baseline">
                                <span className="text-3xl md:text-4xl font-bold text-[#212626]">₹249.00</span>
                                <span className="ml-2 text-sm md:text-base text-[#667085]">per month</span>
                            </div>
                            <div className="text-[#667085] text-xs md:text-sm mt-1">
                                ₹2,988.00/year <span className="text-[#667085]">Billed annually</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 md:space-y-4 flex-grow">
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    ...
                                    <span className="text-[#212626] font-medium">2 Businesses</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    <span className="text-[#667085]">Create upto </span>
                                    <span className="text-[#212626] font-medium">100 Invoices</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    <span className="text-[#667085]">List Upto </span>
                                    <span className="text-[#212626] font-medium">200 Products</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    <span className="text-[#667085]">Generate </span>
                                    <span className="text-[#212626] font-medium">Multiple Category Reports</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Custom Templates</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-[#e5e7eb] rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col shadow-lg sm:col-span-2 lg:col-span-1">
                        <h2 className="text-xl md:text-2xl font-semibold text-[#212626] mb-1 md:mb-2">Enterprise</h2>
                        <p className="text-[#667085] text-sm md:text-base mb-4 md:mb-6 whitespace-nowrap min-h-[20px] md:min-h-[24px]">
                        ...
                        <div className="mb-4 md:mb-6">
                            <div className="flex items-baseline">
                                <span className="text-3xl md:text-4xl font-bold text-[#212626]">Contact Us</span>
                                <span className="ml-2 text-[#667085]"></span>
                            </div>
                            <div className="text-[#667085] text-xs md:text-sm mt-1">Get in touch for a tailored price quote.</div>
                        </div>
                        ...
                        <div className="space-y-3 md:space-y-4 flex-grow">
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div className="text-sm md:text-base">
                                    <span className="text-[#667085]">Manage upto </span>
                                    <span className="text-[#212626] font-medium">5 Businesses</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Unlimited User Access</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Unlimited Invoices</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Unlimited Products</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 md:gap-3">
                                <Check className="h-4 w-4 md:h-5 md:w-5 text-[#1eb386] mt-0.5 flex-shrink-0" />
                                <div className="text-sm md:text-base">
                                    <span className="text-[#212626] font-medium">Unlimited Parties</span>
                                </div>
                            </div>
